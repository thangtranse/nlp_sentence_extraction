...
from nlp_practice.selection import normalize_scores
...
def main() -> None:
    ...
    for topic_path in topic_files:
        ...
        similarity_matrix = build_similarity_matrix(tfidf_vectors, SIMILARITY_THRESHOLD)
        ...
        ranked_sentences = rank_sentences_by_pagerank(
